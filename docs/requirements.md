...
- Name: DocuMind Lite
- Category: RAG / Knowledge Starter App
- Summary: A lightweight governed RAG starter app for uploading documents, chunking, embedding, vector search, cited chat, local mode, and Docker Compose.
- Priority: Phase 3
- Cerebra MCP fit: CerebraKnowledge-mcp, CerebraSecurity-mcp, CerebraReview-mcp, CerebraTesting-mcp

## 3. Goals

- Provide a complete MVP path from input to usable output.
- Make DocuMind Lite understandable to public GitHub visitors without requiring private Cerebra context.
...
The person who runs DocuMind Lite to create or inspect the target artifact. They need clear setup, fast feedback, and usable output.
...
- Output must match the RAG / Knowledge Starter App use case.
...
Main risk areas: hallucinated citations, sensitive documents, poor extraction quality, stale embeddings, retention mistakes
...
- a new user can understand DocuMind Lite from README.md
