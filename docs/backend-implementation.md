# DocuMind Lite Backend Implementation Specification
...
- Database: PostgreSQL with pgvector or Qdrant plus object storage for documents.
- Queue: Extraction, chunking, embedding, reindex jobs.
...
- workspace_id
- name
- domain: 'governed RAG starter app'
- status
- owner_user_id
- metadata_json
- created_at
...
1. Create project for governed RAG starter app.
...
- Worker can complete the primary governed RAG starter app workflow using sample inputs.
