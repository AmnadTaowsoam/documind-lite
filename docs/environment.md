# DocuMind Lite Environment And Configuration
...
PORT=4310
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/documind_lite
...
OBJECT_STORAGE_BUCKET=documind-lite-artifacts
GITHUB_TOKEN=
OPENAI_API_KEY=
ANTHROPIC_API_KEY=
SENTRY_DSN=
